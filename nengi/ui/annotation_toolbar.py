...
class CollapsibleAnnotationToolbar(QFrame):
    ...
    def _setup_ui(self):
        ...
        self.lbl_title = QLabel("Genişletilmiş Araçlar")
        ...
        content_layout.addLayout(prop_layout)
    ...
    def update_theme(self, is_dark: bool):
        ...
        # Update header
        title_color = text
        self.lbl_title.setStyleSheet(f"font-size: 12px; font-weight: 600; color: {title_color};")
        chevron_color = text
        self.btn_chevron.setIcon(get_svg_icon("chevron_up" if self._expanded else "chevron_down", chevron_color, 16))
        self.btn_chevron.setStyleSheet(f"QPushButton {{ border: none; background: transparent; border-radius: 14px; color: {chevron_color}; }}"
